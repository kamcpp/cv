...
\usepackage[a4paper, left=1.5cm, top=1cm, right=1.5cm, bottom=2.0cm]{geometry}
\usepackage{layout}
\usepackage{sectsty}
\usepackage{titlesec}
...
\textbullet \hspace{0.1cm}\textbf{Computer Networks:} OSI \& Internet Protocol Suite, Packet Switching, Error Detection \& Correction (Checksum, CRC, ARQ, FEC), L3 protocols (ICMP, IP) - L4 protocols (UDP, TCP) - Socket Programming - L3 programming - Wireshark analysis - Penetration Testing \\
