...
\noindent \rule {18.0cm}{0.2pt} \\
\noindent
\textbullet \hspace{0.1cm}\textbf{Expert Level Programming Languages:} C++14 (\texttt{g++}, \texttt{clang++}) - C11 (\texttt{gcc}, \texttt{clang}) - Java - Python \\
\textbullet \hspace{0.1cm}\textbf{Some-Hands-On Programming Languages:} Scala - x86-64 Assembly - Erlang \\
\textbullet \hspace{0.1cm}\textbf{Paradigms:} Procedural - OOP - Functional - Actor Model - Aspect Oriented\\
\textbullet \hspace{0.1cm}\textbf{Web Development:} Apache httpd - CGI (PHP, Python, Perl) - Java Servlets (Wildfly, Jetty, Tomcat, Glassfish) - Spring MVC - Play \\
...
\textbullet \hspace{0.1cm}\textbf{DevOps Skills:} Bash Scripting - Perl - Python - KVM - Docker - Jenkins - Zabbix \\
