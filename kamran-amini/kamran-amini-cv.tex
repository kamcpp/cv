...
\textbullet \hspace{0.1cm}\textbf{Machine Learning:} CUDA Dev. - Tensorflow (C++ \& Python) - DSP - OpenCV - Supervised \& Unsupervised Learning - Reinforced Learning - Deep Learning - Locality Sensitive Hashes - Feature Selection \& Extraction \\
...
\textbullet \hspace{0.1cm}\textbf{Build Systems:} Makefile - CMake - Ninja - Ant - Gradle - Maven - Bazel - sbt \\
\textbullet \hspace{0.1cm}\textbf{IDEs:} Vim as IDE (\heart  \smiley) - IntelliJ IDEA - MS Visual Studio \\
